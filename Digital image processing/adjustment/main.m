...
I = imread('liulian.jpeg');    % 读取源图像并显示
...
rgbhsv = hsv2rgb(hsv_image);    % 将hsv颜色空间转换为rgb颜色空间，并显示
...
rgbhsi = hsi2rgb(hsi_image);    % 将hsi颜色空间转换为rgb颜色空间，并显示


figure;
subplot(131);imshow(I);title('原图');
subplot(132);imshow(rgbhsv);title('hsv颜色空间');
subplot(133);imshow(rgbhsi);title('hsi颜色空间');